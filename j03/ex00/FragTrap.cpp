...
/*   Updated: 2017/01/13 12:23:02 by tle-meur         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
unsigned int FragTrap::vaulthunter_dot_exe( std::string const & target )
{
	...
	std::string arrayOfNames[6] = {"awesome melee attack", "unicorn inutility attack", "shitty melee attack", "awesome ranged attack", "shitty ranged attack" };
